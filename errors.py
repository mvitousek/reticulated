...
codes = {
    ...
    'RETURN_NONEXISTANT': 'A return value of type %s was expected but no value is returned.',
    'SINGLE_ASSIGN_ERROR': 'Assignee was expected to be of type %s, but value %%s provided instead.',
    'MULTI_ASSIGN_ERROR': 'Assignee was expected to be compatible with types %s, but value %%s provided instead.',
    ...
    'FALLOFF': 'Not all paths of execution through function %s return a value.',
